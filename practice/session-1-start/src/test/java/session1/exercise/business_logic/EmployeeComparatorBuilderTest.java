...
public class EmployeeComparatorBuilderTest {
    ...
    public void givenAListOfEmployees_whenSortingThemAscendingByFirstName_thenTheEmployeesAreSortedCorrectly() {
        ...
        List<Employee> actualEmployees = new session1.exercise.business_logic.EmployeeComparatorBuilder().sortByFirstName(employees, true);
    ...
    public void givenAListOfEmployees_whenSortingThemDescendingByFirstName_thenTheEmployeesAreSortedCorrectly() {
        ...
        List<Employee> actualEmployees = new session1.exercise.business_logic.EmployeeComparatorBuilder().sortByFirstName(employees, false);
    ...
    public void givenAListOfEmployees_whenSortingThemAscendingByAge_thenTheEmployeesAreSortedCorrectly() {
        ...
        List<Employee> actualEmployees = new session1.exercise.business_logic.EmployeeComparatorBuilder().sortByAge(employees, true);
    ...
    public void givenAListOfEmployees_whenSortingThemDescendingByAge_thenTheEmployeesAreSortedCorrectly() {
        ...
        List<Employee> actualEmployees = new session1.exercise.business_logic.EmployeeComparatorBuilder().sortByAge(employees, false);
